...
exports.generateOverdueFindingsReport = async (req, res) => {
  try {
    ...
    const pdfBuffer = await page.pdf({
      ...
      headerTemplate: '<span id="confidential" style="font-size: 14px; font-weight: bold; width: 250px; height: 20px; color:red; margin: 20px;">Confidential - Internal Use Only</span>',
      footerTemplate:
